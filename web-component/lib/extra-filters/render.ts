...
export function renderHTML(): string {
  ...
  <div class="jb-extra-filter-web-component">
    ...
    <div class="column-select-wrapper" part="column-select-wrapper">
      <jb-select class="filter-select" placeholder="${dictionary.get(i18n,"selectPlaceholder")}">
    ...
    <div class="intent-wrapper --hide" part="intent-wrapper">
      ...
      <button class="intent-submit-button" part="intent-submit-button" type="button" disabled aria-label="${dictionary.get(i18n, "submitTitle")}">
